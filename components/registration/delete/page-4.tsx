                ...
                {values.relevanceAnswer.filename ? (
                  <div className="flex items-center gap-2 ">
                    ...
                    <Trash2
                      ...
                      className="shrink-0"
                      onClick={() => {
                        setFieldValue("relevanceAnswer.filename", "");
                        setFieldValue("relevanceAnswer.fileLocation", "");
                      }}
                    />
                  </div>
                ) : (
                  <Input
                    ...
                    onFocus={() => {
                      setTimeout(() => {
                        setFieldTouched("relevanceAnswer.fileLocation", true),
                          validateField("relevanceAnswer.fileLocation");
                      }, 3000);
                    }}
                    onBlur={() => {
                      setTimeout(() => {
                    ...
                    onChange={async (e) => {
                      ...
                      setFieldValue("relevanceAnswer.filename", file.filename);
                      setFieldValue(
                        "relevanceAnswer.fileLocation",
                        file.location
                      );
                    }}
                  />
